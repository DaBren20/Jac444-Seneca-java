...
public class Rectangle implements Shapes {
	...
	public ShapeArea obj = () -> getSideA() * getSideB();
	...
	public String toString() {
		return String.format("Rectangle {w=%.1f, h=%.1f} perimeter = %06g Area = %06g", getSideA(), getSideB(), calculatePerimeter(), obj.calculateArea());
	}
